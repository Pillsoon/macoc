...
export const metadata: Metadata = {
  title: 'Registration',
  description: 'Register for the Musical Arts Competition of Orange County. View fees, deadlines, and division requirements.',
  alternates: { canonical: '/competition/registration' },
}
