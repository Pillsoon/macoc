...
interface WoodwindsEnsembleRegistrationFormProps {
  division: string
...
export function getRequiredMemberCount(instrumentation: string): number {
  ...
  if (lower === 'quintet') return 5
  if (lower === 'quartet') return 4
  if (lower === 'trio') return 3
  if (lower === 'duo') return 2
  return 0
}
...
export default function WoodwindsEnsembleRegistrationForm({
  division,
  sections,
}: WoodwindsEnsembleRegistrationFormProps) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const response = await fetch('/api/woodwinds-ensemble-registration', {
        method: 'POST',
        ...
        {step === 1 && (
          <div className="space-y-6">
            ...
            <div>
              ...
              <p className="text-xs text-text-muted mb-1">(by the oldest member in the group as of April 30)</p>
            ...
            <div>
              ...
              <p className="text-xs text-text-muted mb-1">(any combination of instruments)</p>
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                  ...
                  <div>
                    ...
                    <input type="text" value={member.instrument} onChange={(e) => updateMember(i, 'instrument', e.target.value)}
                      placeholder="e.g. Flute, Clarinet, Oboe"
